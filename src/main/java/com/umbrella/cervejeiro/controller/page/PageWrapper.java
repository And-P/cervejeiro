package com.umbrella.cervejeiro.controller.page;
...
public class PageWrapper<T> {
	...
	public PageWrapper(Page<T> page, HttpServletRequest httpServletRequest){
		this.page = page;
		//this.uriBuilder = ServletUriComponentsBuilder.fromRequest(httpServletRequest); //dá bug em pesquisas com espaço
