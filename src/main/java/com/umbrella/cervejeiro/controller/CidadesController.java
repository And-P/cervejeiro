...
import com.umbrella.cervejeiro.service.CadastroCidadeService;
...
public class CidadesController {
	...
	public @ResponseBody List<Cidade> pesquisarPorCogigoEstado(@RequestParam(name="estado", defaultValue = "-1") Long codigoEstado){
